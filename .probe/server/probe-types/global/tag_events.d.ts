...
function tags(extra: "lithostitched:placement_condition_type", handler: (event: TagEventProbe<(Special.PlacementConditionTypeTag), (Special.PlacementConditionType)>) => void): void
function tags(extra: "lithostitched:processor_condition_type", handler: (event: TagEventProbe<(Special.ProcessorConditionTypeTag), (Special.ProcessorConditionType)>) => void): void
...
function tags(extra: "cold_sweat:world/dimension_temp", handler: (event: TagEventProbe<(Special.WorldDimensionTempTag), (Special.WorldDimensionTemp)>) => void): void
...
function tags(extra: "cold_sweat:entity/climate", handler: (event: TagEventProbe<(Special.EntityClimateTag), (Special.EntityClimate)>) => void): void
function tags(extra: "cold_sweat:item/item_temp", handler: (event: TagEventProbe<(Special.ItemItemTempTag), (Special.ItemItemTemp)>) => void): void
function tags(extra: "cold_sweat:item/insulation_slots", handler: (event: TagEventProbe<(Special.ItemInsulationSlotsTag), (Special.ItemInsulationSlots)>) => void): void
function tags(extra: "cold_sweat:item/food", handler: (event: TagEventProbe<(Special.ItemFoodTag), (Special.ItemFood)>) => void): void
function tags(extra: "moonlight:soft_fluids", handler: (event: TagEventProbe<(Special.SoftFluidsTag), (Special.SoftFluids)>) => void): void
function tags(extra: "cold_sweat:item/insulator", handler: (event: TagEventProbe<(Special.ItemInsulatorTag), (Special.ItemInsulator)>) => void): void
...
function tags(extra: "cold_sweat:world/temp_region", handler: (event: TagEventProbe<(Special.WorldTempRegionTag), (Special.WorldTempRegion)>) => void): void
function tags(extra: "cold_sweat:item/drying_item", handler: (event: TagEventProbe<(Special.ItemDryingItemTag), (Special.ItemDryingItem)>) => void): void
function tags(extra: "cold_sweat:entity/spawn_biome", handler: (event: TagEventProbe<(Special.EntitySpawnBiomeTag), (Special.EntitySpawnBiome)>) => void): void
function tags(extra: "cold_sweat:block/block_temp", handler: (event: TagEventProbe<(Special.BlockBlockTempTag), (Special.BlockBlockTemp)>) => void): void
function tags(extra: "cold_sweat:entity/entity_temp", handler: (event: TagEventProbe<(Special.EntityEntityTempTag), (Special.EntityEntityTemp)>) => void): void
function tags(extra: "cold_sweat:world/biome_temp", handler: (event: TagEventProbe<(Special.WorldBiomeTempTag), (Special.WorldBiomeTemp)>) => void): void
function tags(extra: "cold_sweat:modifier", handler: (event: TagEventProbe<(Special.ModifierTag), (Special.Modifier)>) => void): void
function tags(extra: "cold_sweat:entity/temp_effects", handler: (event: TagEventProbe<(Special.EntityTempEffectsTag), (Special.EntityTempEffects)>) => void): void
function tags(extra: "cold_sweat:world/structure_temp", handler: (event: TagEventProbe<(Special.WorldStructureTempTag), (Special.WorldStructureTemp)>) => void): void
...
function tags(extra: "cold_sweat:item/fuel", handler: (event: TagEventProbe<(Special.ItemFuelTag), (Special.ItemFuel)>) => void): void
function tags(extra: "cold_sweat:entity/mount", handler: (event: TagEventProbe<(Special.EntityMountTag), (Special.EntityMount)>) => void): void
