...
function tags(extra: "crafttweaker:condition_serializer", handler: (event: TagEventProbe<(Special.ConditionSerializerTag), (Special.ConditionSerializer)>) => void): void
function tags(extra: "crafttweaker:transformer_serializer", handler: (event: TagEventProbe<(Special.TransformerSerializerTag), (Special.TransformerSerializer)>) => void): void
