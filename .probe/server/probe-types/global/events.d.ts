...
export namespace MEJSEvents {
function entityStartRiding(extra: $EntityType$Type, handler: (event: $PlayerRideEntityEventJS) => void): void
function entityStartRiding(handler: (event: $PlayerRideEntityEventJS) => void): void
function chunkTick(handler: (event: $ChunkTickEventJS) => void): void
function deathMessage(handler: (event: $DeathMessageEventJS) => void): void
function entityRandomTeleport(handler: (event: $EntityRandomTeleportEventJS) => void): void
function entityStopRiding(extra: $EntityType$Type, handler: (event: $PlayerStopRidingEventJS) => void): void
function entityStopRiding(handler: (event: $PlayerStopRidingEventJS) => void): void
function entityMove(extra: $EntityType$Type, handler: (event: $EntityMoveEventJS) => void): void
function entityMove(handler: (event: $EntityMoveEventJS) => void): void
function newDay(handler: (event: $NewDayEventJS) => void): void
function blockCollision(handler: (event: $BlockCollisionEventJS) => void): void
function entityCollision(extra: $EntityType$Type, handler: (event: $EntityCollisionEventJS) => void): void
function entityCollision(handler: (event: $EntityCollisionEventJS) => void): void
function entityTick(extra: $EntityType$Type, handler: (event: $EntityTickEventJS) => void): void
function entityTick(handler: (event: $EntityTickEventJS) => void): void
function standOnFluid(handler: (event: $StandOnFluidEventJS) => void): void
function durabilityDamage(extra: $Item$Type, handler: (event: $ItemDurabilityDamageEventJS) => void): void
function durabilityDamage(handler: (event: $ItemDurabilityDamageEventJS) => void): void
}
...
export namespace BlockEntityEvents {
function death(handler: (event: $BlockEntityDeathEventJS) => void): void
function tick(handler: (event: $BlockEntityTickEventJS) => void): void
}
...
function shoot(handler: (event: $ProjectileShootEventJS) => void): void
function tick(extra: $EntityType$Type, handler: (event: $ProjectileTickEventJS) => void): void
function tick(handler: (event: $ProjectileTickEventJS) => void): void
}
...
export namespace ItemEntityEvents {
function death(handler: (event: $ItemEntityHurtEventJS) => void): void
function tick(handler: (event: $ItemEntityTickEventJS) => void): void
function hurt(handler: (event: $ItemEntityDeathEventJS) => void): void
}
export namespace KuEvents {
function playerStarterItems(handler: (event: $PlayerStarterItems) => void): void
}
