...
public "toString"(): string
public "hashCode"(): integer
public "handler$hab000$axiom$vertexBufferSize"(cir: $CallbackInfoReturnable$Type<(any)>): void
...
public "handler$haa001$axiom$begin"(ci: $CallbackInfo$Type): void
public "handler$haa000$axiom$reset"(ci: $CallbackInfo$Type): void
...
public "handler$haa000$axiom$endVertex"(ci: $CallbackInfo$Type): void
public "localvar$haa000$axiom$modifyCapacity"(value: integer): integer
...
public "handler$gpo000$axiom$setGuiScale"(d: double, ci: $CallbackInfo$Type): void
public "handler$gpo000$axiom$getScreenWidth"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gpo000$axiom$getHeight"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gpo000$axiom$getWidth"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gpo000$axiom$getScreenHeight"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gpo000$axiom$onResizeInject"(l: long, i: integer, j: integer, ci: $CallbackInfo$Type): void
public "handler$gpo000$axiom$calculateScale"(scale: integer, forceEven: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
public "getWidth"(): integer
public "getHeight"(): integer
...
public "constant$bld000$dsurround$initialize"(v: integer): integer
...
public "handler$hah000$axiom$blitToScreen"(width: integer, height: integer, noBlend: boolean, ci: $CallbackInfo$Type): void
...
public "handler$ble000$dsurround$onSourceTick"(ci: $CallbackInfo$Type): void
public "handler$ble000$dsurround$monoConversion"(soundBuffer: $SoundBuffer$Type, ci: $CallbackInfo$Type): void
public "handler$ble000$dsurround$onSourceStop"(ci: $CallbackInfo$Type): void
public "handler$ble000$dsurround$onSourcePlay"(ci: $CallbackInfo$Type): void
