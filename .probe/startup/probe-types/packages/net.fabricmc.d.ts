...
declare module "packages/net/fabricmc/api/$ClientModInitializer" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
export interface $ClientModInitializer {
...
export namespace $ClientModInitializer {
const probejs$$marker: never
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $ClientModInitializer$Type = ($ClientModInitializer);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ClientModInitializer_ = $ClientModInitializer$Type;
}}
...
declare module "packages/net/fabricmc/loader/api/$Version" {
...
function parse(arg0: string): $Version
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
