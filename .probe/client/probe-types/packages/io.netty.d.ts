...
declare module "packages/io/netty/util/internal/shaded/org/jctools/queues/$MessagePassingQueue$Consumer" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/**
 * This class is not allowed By KubeJS!
 * You should not load the class, or KubeJS will throw an error.
 * Loading the class using require() will not throw an error, but the class will be undefined.
 */
export interface $MessagePassingQueue$Consumer<T> {
...
export namespace $MessagePassingQueue$Consumer {
const probejs$$marker: never
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $MessagePassingQueue$Consumer$Type<T> = ($MessagePassingQueue$Consumer<(T)>);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $MessagePassingQueue$Consumer_<T> = $MessagePassingQueue$Consumer$Type<(T)>;
}}
