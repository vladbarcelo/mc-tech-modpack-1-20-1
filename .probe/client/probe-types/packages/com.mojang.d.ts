...
public "toString"(): string
public "hashCode"(): integer
public "handler$gkh000$axiom$vertexBufferSize"(cir: $CallbackInfoReturnable$Type<(any)>): void
...
import {$BufferBuilderExt, $BufferBuilderExt$Type} from "packages/com/moulberry/axiom/hooks/$BufferBuilderExt"
...
export class $BufferBuilder extends $DefaultedVertexConsumer implements $BufferVertexConsumer, $BufferBuilderExtension, $IBufferBuilder, $ETFVertexConsumer, $BufferBuilderAccessor, $BufferBuilderExt, $ExtendedBufferBuilder, $VertexBufferWriter {
 "vertices": integer
 "format": $VertexFormat
...
public "handler$gkg001$axiom$begin"(ci: $CallbackInfo$Type): void
public "handler$gkg000$axiom$reset"(ci: $CallbackInfo$Type): void
...
public "axiom$getVertexPointer"(): long
public "axiom$reserve"(bytes: integer): long
public "axiom$endVertexIfStarted"(): void
public "axiom$startVertex"(): void
public "axiom$release"(): void
...
public "localvar$gkg000$axiom$modifyCapacity"(value: integer): integer
public "handler$gkg000$axiom$endVertex"(ci: $CallbackInfo$Type): void
...
import {$MixinSoundBuffer, $MixinSoundBuffer$Type} from "packages/org/orecruncher/dsurround/mixins/audio/$MixinSoundBuffer"
import {$ByteBuffer, $ByteBuffer$Type} from "packages/java/nio/$ByteBuffer"
import {$OptionalInt, $OptionalInt$Type} from "packages/java/util/$OptionalInt"

export class $SoundBuffer implements $MixinSoundBuffer {
...
import {$NativeImageAccessor, $NativeImageAccessor$Type} from "packages/de/cheaterpaul/fallingleaves/mixin/$NativeImageAccessor"
import {$NativeImageExt, $NativeImageExt$Type} from "packages/com/moulberry/axiom/hooks/$NativeImageExt"
import {$NativeImageAccessor as $NativeImageAccessor$0, $NativeImageAccessor$Type as $NativeImageAccessor$0$Type} from "packages/me/jellysquid/mods/sodium/mixin/features/textures/$NativeImageAccessor"
...
export class $NativeImage implements $AutoCloseable, $NativeImageAccessor, $NativeImageExt, $NativeImageAccessor$0 {
 "pixels": long
...
import {$WindowExt, $WindowExt$Type} from "packages/com/moulberry/axiom/hooks/$WindowExt"
...
public "close"(): void
public "axiom$resize"(window: long, width: integer, height: integer): void
public "axiom$refreshFramebufferSize"(): void
public "handler$gke000$axiom$getScreenHeight"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gke000$axiom$getHeight"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gke000$axiom$getScreenWidth"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gke000$axiom$setGuiScale"(d: double, ci: $CallbackInfo$Type): void
public "handler$gke000$axiom$calculateScale"(scale: integer, forceEven: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gke000$axiom$getWidth"(cir: $CallbackInfoReturnable$Type<(any)>): void
public "handler$gke000$axiom$onResizeInject"(l: long, i: integer, j: integer, ci: $CallbackInfo$Type): void
...
import {$List, $List$Type} from "packages/java/util/$List"
import {$ISoundEngine, $ISoundEngine$Type} from "packages/org/orecruncher/dsurround/mixinutils/$ISoundEngine"

export class $Library implements $ISoundEngine {

constructor()

public "constant$bkh000$dsurround$initialize"(v: integer): integer
public "dsurround_getDevicePointer"(): long
...
(arg0: $TypeRewriteRule$Type, arg1: boolean, arg2: boolean): $TypeRewriteRule
}
...
import {$AccessoriesFrameBufferExtension, $AccessoriesFrameBufferExtension$Type} from "packages/io/wispforest/accessories/pond/$AccessoriesFrameBufferExtension"
import {$CallbackInfo, $CallbackInfo$Type} from "packages/org/spongepowered/asm/mixin/injection/callback/$CallbackInfo"
...
public "handler$gkn000$axiom$blitToScreen"(width: integer, height: integer, noBlend: boolean, ci: $CallbackInfo$Type): void
...
import {$Vec3, $Vec3$Type} from "packages/net/minecraft/world/phys/$Vec3"
import {$ISourceContext, $ISourceContext$Type} from "packages/org/orecruncher/dsurround/mixinutils/$ISourceContext"

export class $Channel implements $ISourceContext {
static readonly "BUFFER_DURATION_SECONDS": integer


public "handler$bki000$dsurround$onSourceStop"(ci: $CallbackInfo$Type): void
public "handler$bki000$dsurround$onSourcePlay"(ci: $CallbackInfo$Type): void
public "handler$bki000$dsurround$monoConversion"(soundBuffer: $SoundBuffer$Type, ci: $CallbackInfo$Type): void
public "handler$bki000$dsurround$onSourceTick"(ci: $CallbackInfo$Type): void
public "dsurround_getId"(): integer
public "dsurround_setData"(data: $SourceContext$Type): void
public "dsurround_getData"(): $Optional<(any)>
public "stop"(): void
public "unpause"(): void
public "pause"(): void
