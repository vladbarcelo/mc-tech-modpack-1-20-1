ServerEvents.recipes((event) => {
  for (let metal of global.allMetals) {
    ...
    let altMoltenMetal = global.tconstructMoltenMetals[metal]

    addMetalWorksRecipes(metal, moltenMetal, event)
    if (altMoltenMetal) addMetalWorksRecipes(metal, altMoltenMetal, event)
  }
});

function addMetalWorksRecipes(metal, moltenMetal, event) {
